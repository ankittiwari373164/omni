...
//   -> { result: "<text>" }
// ============================================================================
// NOTE: These old callChatGPT functions are DEPRECATED
// Use persistent ChatGPT profiles instead (lib/save-sessions.js)
// ============================================================================

async function callChatGPT(promptText, chatLink) {
  throw new Error("callChatGPT is deprecated — use persistent ChatGPT profile instead (run: node save-sessions.js)");
}

/**
 * DEPRECATED: Use persistent ChatGPT profiles instead
 */
async function generateImage(promptText, chatLink) {
  throw new Error("generateImage via ChatGPT server is deprecated — use persistent ChatGPT profile instead (run: node save-sessions.js)");
}
