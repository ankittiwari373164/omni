...
Write the prompt as TWO clearly separated 10-second scenes, formatted EXACTLY as:
PART 1:
<complete standalone Flow prompt for the first 10-second clip>
PART 2:
<complete standalone Flow prompt for the second 10-second clip>` : ""}`;
