...
Format EXACTLY as:
PART 1:
<complete Flow prompt for seconds 0-10 — scenes for the first clip>
PART 2:
<complete Flow prompt for seconds 10-20 — opens on the SAME frame/state PART 1 ended on, continues seamlessly>` : ""}`;
