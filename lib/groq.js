...
WRITE IT SCENE BY SCENE: structure the prompt as a short sequence of scenes for
one continuous 10-second vertical video, exactly like this shape:

A 10-second cinematic vertical 9:16 video. [one-line overall look/subject]
Scene 1 (0-3 sec): <what happens>
Scene 2 (3-7 sec): <what happens>
Scene 3 (7-10 sec): <what happens>

Keep each scene line to ONE clear sentence. Same subject, setting, lighting and
style across all scenes so it plays as one continuous shot. No captions, no
on-screen text.
...
module.exports = { generatePrompt, splitPromptParts, sanitizePrompt, generateNewsPrompt, generateCalendar, generateYouTubeMeta, generateVoiceScript, promptStyles };
