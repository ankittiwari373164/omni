    ...
    while (!capturedOpName && Date.now() < deadline) {
      ...
      if (ticks % 3 === 0) {
        ...
        const pageState = await page.evaluate(() => {
          ...
          // Only detect real error cards, not the word "Failed" in nav/UI
          const hasErrorCard = body.includes("unusual activity") ||
            body.includes("Help Center") ||
            (body.includes("Failed") && body.includes("We noticed"));
          return {
