...
const CATEGORIES = {
  ...
  food: {
    label: "Food & Cooking",
    feeds: [
      "https://food.ndtv.com/rss/latest",
  ...
  auto: {
    label: "Auto & EVs",
    feeds: [
      "https://auto.ndtv.com/rss/latest",
  ...
  bollywood: {
    label: "Bollywood & Entertainment (India)",
    feeds: [
  ...
  youtube_creators: {
    label: "YouTube Creators News",
    feeds: [
      "https://blog.youtube/rss/",                                  // official YouTube blog (creator updates, features)
      "https://www.tubefilter.com/feed/",                           // creator economy news
      "https://www.theverge.com/rss/creators/index.xml"             // The Verge creators section
    ]
  },
  world: {
    label: "World News",
